...
public class history_adapter extends RecyclerView.Adapter<history_adapter.ImageViewHolder> {
    ...
    public history_adapter(Context context, List<Clan> clans) {
        mContext = context;
        mclans = clans;
    }
    ...
    public ImageViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(mContext).inflate(R.layout.history, parent, false);
    ...
    public class ImageViewHolder  extends RecyclerView.ViewHolder implements View.OnClickListener,
        ...
        public ImageViewHolder(View itemView) {
            ...
            item_account = itemView.findViewById(R.id.item_account2);
